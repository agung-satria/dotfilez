...
// };
// // agstr color__________________________________________

// // pop color^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
static const char col_gray1[]     = "#141919";
static const char col_gray2[]     = "#39393c";
static const char col_gray3[]     = "#bbbbbb";
static const char col_gray4[]     = "#F3FEFF";
static const char col_cyan[]      = "#313131";
static const char col_pop[]       = "#56B6C2";
...
// pop dmenu color^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_pop, NULL };
...
static Key keys[] = {
    ...
    { 0,  XF86XK_AudioMute,           spawn, SHCMD("pactl set-sink-mute @DEFAULT_SINK@ toggle && snd_mint_volume") },
    { 0,  XF86XK_AudioRaiseVolume,    spawn, SHCMD("pactl set-sink-volume 0 +5% && snd_mint_volume") },
    { 0,  XF86XK_AudioLowerVolume,    spawn, SHCMD("pactl set-sink-volume 0 -5% && snd_mint_volume") },
    { 0,  XF86MonBrightnessUp,        spawn, SHCMD("brightness-setter +5") },
    { 0,  XF86MonBrightnessDown,      spawn, SHCMD("brightness-setter -5") },

    { MODKEY,			        XK_0,		    spawn,		SHCMD("pactl set-sink-mute @DEFAULT_SINK@ toggle && snd_mint_volume") },
    { MODKEY,			        XK_equal,		spawn,		SHCMD("pactl set-sink-volume 0 +5% && snd_mint_volume") },
    { MODKEY,			        XK_minus,		spawn,		SHCMD("pactl set-sink-volume 0 -5% && snd_mint_volume") },
    { MODKEY|ShiftMask,		XK_equal,		spawn,		SHCMD("brightness-setter +5") },
    { MODKEY|ShiftMask,		XK_minus,		spawn,		SHCMD("brightness-setter -5") },
...
//    { MODKEY|ShiftMask,		    	XK_c,             spawn,	    SHCMD("gnome-calendar") },
    ...
    //{ MODKEY|ControlMask,           XK_Return, spawn,          SHCMD("tabbed -r 2 st -w ''") }, //open tmux in tabbed st
